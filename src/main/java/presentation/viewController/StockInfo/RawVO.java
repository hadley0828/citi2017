...
//        private String rawMaterial_variety;    //原材料种类
    private final SimpleStringProperty rawMaterial_variety;
        ...
        public RawVO(String rMaterial_variety, String voucher_id, String datetime, boolean is_delivery_ontime, boolean is_return, int input_num,double input_price, double input_account,
